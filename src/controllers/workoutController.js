...
const createWorkout = (req, res) => {
    ...
    if(!body.name ||
        ...
        !body.trainerTips)
    {
        res.status(401).send({status: "FAILED", data: {error: "One of the followings keys is missing or is empty in the request body: 'name','mode','equipment','exercises','trainerTips'"}})
    }
